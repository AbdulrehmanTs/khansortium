            ...
            <li>Upcomming Events</li>
                ...
                <ul className="lastList">
                    <ul className="socials">
                        <li>
                            <a target='_blank' rel="noreferrer" href='https://www.facebook.com/Khansortium-111918071264923'>
                        ...
                        <li>
                            <a target='_blank' rel="noreferrer" href="https://www.linkedin.com/company/khansortium/about/?viewAsMember=true">
                        ...
                        <li>
                            <a target='_blank' rel="noreferrer" href="https://twitter.com/khansortium">
                                <i className="fab fa-twitter"></i>
                            </a>
                        </li>

                        <li>
                            <a target='_blank' rel="noreferrer" href="https://www.instagram.com/khansortium/">
